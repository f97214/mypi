...
TBD - created by archiving change 'add-zh-tw-localization'. Update Purpose after archive.
...
code:
  ...
  - .pi/extensions/i18n-zh-TW.ts
  - packages/coding-agent/src/core/compaction/compaction.ts
  - packages/coding-agent/src/core/i18n.ts
...
tests:
  ...
  - packages/coding-agent/test/i18n.test.ts
-->
